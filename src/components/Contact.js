...
export default function Contact({ contact, currentUser }) {
  ...
  return (
    <>
      ...
      >
        <div className="relative flex items-center justify-between px-2 py-2 rounded-lg cursor-pointer hover:bg-indigo-50 hover:shadow-sm group">
          <img
            className="hidden object-cover w-10 h-10 mr-2 rounded-full sm:block"
            src={contact.imageURL || no_avatar}
            alt=""
          />
          <div className="grid items-center flex-1 grid-cols-2 mx-4 sm:grid-cols-3 md:grid-cols-4">
